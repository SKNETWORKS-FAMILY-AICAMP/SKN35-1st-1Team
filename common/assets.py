...
SCENE_SVG = f"""<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 720 300">
  <defs>
    ...
    <linearGradient id="floorGrad" x1="0" y1="0" x2="0" y2="1">
      <stop offset="0" stop-color="#cdd8e8"/>
  ...
  <!-- 바닥 (하단 그라데이션, #fff8f0로 마무리) -->
  <rect x="0" y="236" width="720" height="64" fill="url(#floorGrad)"/>
  ...
  <!-- 루프 사인 -->
  <rect x="298" y="86" width="62" height="22" rx="6" fill="#8d9a59"/>
  ...
  <!-- 체커 스트라이프 -->
  <rect x="86" y="188" width="330" height="14" fill="#8d9a59" opacity="0.92"/>
  <g fill="#ffffff">
